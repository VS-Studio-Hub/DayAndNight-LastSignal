...
public class CameraManager : MonoBehaviour
{
    ...
    public LayerMask collisionLayers; //The layers that the camera will check for collisions with
    private float defaultPosition;
    private Vector3 cameraFollowVelocity = Vector3.zero;
    private Vector3 cameraVectorPosition;

    public float cameraCollisionOffSet = 0.2f;  //The amount the camera will be offset from the collision point
    public float minimumCollisionOffSet = 0.2f; //The minimum amount the camera will be offset from the collision point
